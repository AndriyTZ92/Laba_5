...
fun AddRabotnikDialog(
    state: PracivnukState,
    onEvent: (PracivnukEvent) -> Unit,
    ...
    AlertDialog(
        ...
        onDismissRequest = {
            onEvent(PracivnukEvent.HideDialog)
        },
        text = {
            Column(
                ...
                TextField(
                    ...
                    value = state.name,
                    onValueChange = {
                        onEvent(PracivnukEvent.SetName(it))
                    },
                    placeholder = {
                        Text(text = "Name")
                    }
                ...
                TextField(
                    ...
                    onValueChange = { newValue ->
                        onEvent(PracivnukEvent.SetZarplata(newValue))
                    },
                    placeholder = {
                ...
                TextField(
                    ...
                    onValueChange = { newValue ->
                        ...
                        if (number != null) {
                            onEvent(PracivnukEvent.SetExperience(number.toString()))}},
                    placeholder = {
                ...
                if (state.position == "Designer") {
                    TextField(
                        ...
                        onValueChange = { newValue ->
                            ...
                            if (number != null) {
                                onEvent(PracivnukEvent.SetEfficiency(number.toString()))
                ...
                Column(
                    ...
                    )
                    {
                        RadioButton(
                            ...
                            onClick = { onEvent(PracivnukEvent.SetPosition("Developer")) }
                        )
                        Text(text = "Developer") }
                }
                Column(
                    ...
                    RadioButton(
                        ...
                        onClick = { onEvent(PracivnukEvent.SetPosition("Designer")) }
                    )
                    Text(text = "Designer")
                }}
                    ...
                    Button(
                        onClick = {
                            if (!isEfficiencyEmpty.value || state.position == "Developer") {
                                onEvent(PracivnukEvent.SavePracivnuk)
                            }
                        },
